...
class Task2:
    ...
    def odometry_callback(self, msg):
        ...
        input_x = cur_position.x
        input_y = cur_position.y
        ...
        # set control
        velocity = Twist()
        self.MPC.update_coord(cur_position.x,  cur_position.y, cur_rot_z, lin_vel, ang_vel)
        u = self.MPC.compute_action(self.t, dist_to_goal)
